...
import { Direction, TradeMode, PrimitNavigation, Leverage, EditOperation, CloseOperation } from "./types";
...
export class PrimitApp extends BasePage {
  ...
  async navigateTo(page: PrimitNavigation) {
