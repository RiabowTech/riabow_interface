...
import { PendingTransaction, usePendingTxns } from "@/modules/lighter/context/PendingTxnsContext";
...
import { selectOrdersInfoData, selectTokensData } from "@/modules/lighter/store/SyntheticsStateContext/selectors/globalSelectors";
...
} from "@/modules/lighter/context/TokensBalancesContext/TokensBalancesContextProvider";
      ...
      const handleTxnSubmitted = async () => {
        ...
        addOptimisticTokensBalancesUpdates(
          mapValues(
            ...
            (amount): TokenBalanceUpdate => ({
              diff: -amount,
              isPending: true,
              balanceType: expressParams?.isTradingAccount ? "tradingAccount" : "wallet",
            })
          )
        );
        ...
        if (expressParams) {
          setPendingExpressTxn({
            ...
            successMessage,
            errorMessage,
            isTradingAccount: expressParams.isTradingAccount,
          });
        }
      };
