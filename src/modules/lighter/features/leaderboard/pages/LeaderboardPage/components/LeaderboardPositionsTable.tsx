...
import { useTokenInfo } from "@/modules/lighter/store/SyntheticsStateContext/hooks/globalsHooks";
import { useLeaderboardIsCompetition } from "@/modules/lighter/store/SyntheticsStateContext/hooks/leaderboardHooks";
import { useMarketInfo } from "@/modules/lighter/store/SyntheticsStateContext/hooks/marketHooks";
import {
  selectPositionConstants,
  selectUserReferralInfo,
} from "@/modules/lighter/store/SyntheticsStateContext/selectors/globalSelectors";
import { makeSelectMarketPriceDecimals } from "@/modules/lighter/store/SyntheticsStateContext/selectors/statsSelectors";
  ...
  return (
    <div className="LeaderboardTable-panel rounded-b-8 bg-slate-900 w-full max-w-full overflow-hidden">
      <TableScrollFadeContainer className="flex grow flex-col">
        <table className="w-[max(100%,1024px)] table-fixed">
          <thead>
