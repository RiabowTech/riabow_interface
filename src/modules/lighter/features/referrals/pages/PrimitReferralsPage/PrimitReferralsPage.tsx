...
import { Button, ExchangeTabs, PrimaryActionButton, PrimitCornerBracketFrame } from "shared/ui";
...
import { refFigmaAsset } from "./primitReferralsFigmaAssets";
...
import "./PrimitReferralsPage.css";

/** Figma Primit-Website v1.0 · Referrals 156:2400 — tier ladder (invitees + volume + display rate) */
...
export type PrimitReferralsPageProps = {
...
export function PrimitReferralsPage({
  chainId,
  account,
  active,
