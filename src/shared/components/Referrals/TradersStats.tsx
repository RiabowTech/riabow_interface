    ...
    <div className="flex flex-col gap-8">
      ...
      {currentDiscountDistributions.length > 0 ? (
        <Card
          ...
          tooltipText={t`Perps fee discounts are automatically applied on each trade and are not displayed on this table.`}
          bodyPadding={false}
          divider={true}
        >
        ...
        <EmptyMessage
          tooltipText={t`Perps rebates are automatically applied as fee discounts on each trade and are not displayed on this table.`}
