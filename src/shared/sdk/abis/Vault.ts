export default [
  ...
  {
    name: "InsufficientInstitutionalBalance",
    type: "error",
    inputs: [
      { name: "requested", type: "uint256" },
      { name: "available", type: "uint256" },
  ...
  { name: "InvalidSignatureLength", type: "error", inputs: [{ name: "length", type: "uint256" }] },
